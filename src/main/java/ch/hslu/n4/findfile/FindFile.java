...
public final class FindFile {
    ...
    private static final Logger LOG = LogManager.getLogger(ch.hslu.n4.findfile.FindFile.class);
     ...
     */
    public static File findFile(final String name, final File dir) {
