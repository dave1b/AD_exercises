...
public final class RaceHorse implements Runnable {
    ...
    private static final Logger LOG = LogManager.getLogger(ch.hslu.n2.latch.RaceHorse.class);
    ...
    public void run() {
        ...
        try {
        	...
        	LOG.info("Das Rennen wurde unterbrochen. Pferd " + runThread.getName() + " geht zurück in die Box");
        	LOG.debug(ex);
        	return;
        }
